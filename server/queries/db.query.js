...
query.createWorkout =
  'INSERT INTO workout(name, goal, day, complete) VALUES ($1, $2, $3, $4) RETURNING id';
query.createExercise =
  'INSERT INTO exercise(name, intervals, sets, reps, rest) VALUES ($1, $2, $3, $4, $5) RETURNING id';
query.createSession =
  'INSERT INTO session(ssid, member_id) VALUES ($1, $2) RETURNING *';
...
// update workouts
query.updateWorkout =
  'UPDATE workout SET name = $1, goal = $2, complete = $3 WHERE id = $4';
...
query.updateExercise =
  'UPDATE exercise SET name = $1, intervals = $2, sets = $3, reps = $4, rest = $5 WHERE id = $6';
query.updateExerciseName = 'UPDATE exercise SET name = $1 WHERE id = $2';
query.updateExerciseIntervals =
  'UPDATE exercise SET intervals = $1 WHERE id = $2';
...
query.deleteMemberWorkout =
  'DELETE FROM member_workout WHERE member_id = $1 AND workout_id = $2';

//delete exercise
query.deleteExercise = 'DELETE FROM exercise WHERE id = $1';
//delete workout_exercise
query.deleteWorkoutExercise =
  'DELETE FROM workout_exercise WHERE workout_id = $1 AND exercise_id = $2';
